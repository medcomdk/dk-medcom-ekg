...
* code MS //RCH: Fjern MS fra de nekelte systemer i Core?
* code.coding.code MS //RCH: Fjern MS fra de nekelte systemer i Core?
* code.coding.system MS //RCH: Fjern MS fra de nekelte systemer i Core?
* subject 1..1 MS
